...
import { Clock, CheckCircle, XCircle, Search, User, School, Calendar } from "lucide-react"
...
export default function PrincipalTransfersPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // Fetch transfer requests for this school
        const { data: requests, error } = await supabase
          ...
          `)
          .eq("from_school_id", stats.schoolId)
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage student transfer requests</p>
      </div>
        ...
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>Review and process transfer applications</CardDescription>
            </div>
          ...
          {selectedRequest && (
            <div className="py-4">
              <div className="p-3 bg-secondary/50 rounded-lg mb-4">
                ...
                <p className="text-sm text-muted-foreground">Transferring to: {selectedRequest.to_school_name}</p>
              </div>
              {actionType === "approve" && (
